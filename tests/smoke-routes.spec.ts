...
const locationRoutes: Array<[string, RegExp]> = [
  ...
  ["/electrician/pitstone", /Electrician Pitstone/i],
  ...
  ["/electrician/aldbury", /Electrician Aldbury/i],
  ["/electrician/wilstone", /Electrician Wilstone/i],
  ["/electrician/wigginton", /Electrician Wigginton/i],
  ["/electrician/long-marston", /Electrician Long Marston/i],
  ["/electrician/cheddington", /Electrician Cheddington/i],
  ["/electrician/little-gaddesden", /Electrician Little Gaddesden/i],
