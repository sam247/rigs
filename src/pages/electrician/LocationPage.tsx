                  ...
                  <Card key={s.title} className="border-2 border-border">
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <Link to={s.href} className="text-sm font-heading font-600 text-primary hover:text-primary/80 transition-colors">
                          View service →
                        </Link>
                      </div>
                      <p className="text-sm text-muted-foreground leading-relaxed mt-2">
                        {s.body}{" "}
                        <Link to={s.href} className="text-primary font-heading font-600 hover:text-primary/80 transition-colors">
                          Learn more
                        </Link>
                        .
                      </p>
