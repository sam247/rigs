        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-sm max-w-none">
              ...
              <h2 className="font-heading font-800">What Is a Fuse Box?</h2>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">While fuse boxes were effective in their time, they come with several drawbacks:</p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                If your home still has rewireable fuses, it may be time to consider an old fuse box replacement.
              </p>

              <h2 className="font-heading font-800">What Is a Consumer Unit?</h2>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <p className="text-muted-foreground leading-relaxed">Modern consumer units typically include:</p>
              <ul className="text-muted-foreground">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Unlike old fuse boxes, consumer units reset at the flick of a switch rather than requiring fuse wire replacement.
              </p>

              <h2 className="font-heading font-800">Key Differences at a Glance</h2>
              <p className="text-muted-foreground leading-relaxed">
                The main differences between a consumer unit vs fuse box come down to safety, convenience, and compliance.
              </p>
            </div>

            <Card className="border-2 border-border my-8">
            ...
            <div className="prose prose-sm max-w-none">
              <ul className="text-muted-foreground">
                <li>
                  Safety: Consumer units provide far better protection, especially with RCDs
                </li>
                <li>
                  Ease of use: No need to replace fuses—just reset the breaker
                </li>
                <li>
                  Compliance: Modern consumer units meet current UK wiring regulations (BS 7671)
                </li>
                <li>
                  Reliability: Less risk of incorrect fuse wire installation
                </li>
              </ul>

              <h2 className="font-heading font-800">Do You Need an Old Fuse Box Replacement?</h2>
              <p className="text-muted-foreground leading-relaxed">
                If you’re unsure whether you need an upgrade, here are some common signs:
              </p>
              <ul className="text-muted-foreground">
                ...
                <li>
                  ...
                  <Link to="/services/emergency-electrician" className="text-primary font-heading font-600 hover:text-primary/80 transition-colors">
              ...
              <h2 className="font-heading font-800">Benefits of a Consumer Unit Upgrade</h2>
              <p className="text-muted-foreground leading-relaxed">
                Investing in a{" "}
                <Link to="/services/fuse-board-upgrades" className="text-primary font-heading font-600 hover:text-primary/80 transition-colors">
              ...
              <p className="text-muted-foreground leading-relaxed">
                It also gives you peace of mind knowing your electrical system is built for today’s demands.
              </p>

              <h2 className="font-heading font-800">Why Choose RIGS Electrical in Tring?</h2>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <h2 className="font-heading font-800">Book Your Consumer Unit Upgrade Today</h2>
              <p className="text-muted-foreground leading-relaxed">
              ...
              <h2 className="font-heading font-800">FAQ</h2>
            </div>
