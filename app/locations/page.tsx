...
export const metadata: Metadata = {
  ...
  description:
    "Find RIGS Electrical coverage across Tring, Luton, Dunstable, Leighton Buzzard, Bedford, Aylesbury, Hemel Hempstead and towns in Hertfordshire, Buckinghamshire and Bedfordshire.",
